    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <h1 className="text-white text-5xl font-bold">SimulAI</h1>
        </NavLink>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* Show Users section only to admin and company roles */}
              ...
              {/* Show Scenarios section with conditional New Scenario button */}
              <SidebarLinkGroup activeCondition={pathname === "/scenarios"}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
              ...
              {/* Show Settings section only to admin users after loading */}
              {!loading && user && currentUser?.role === "admin" && (
                <SidebarLinkGroup
                        ...
                        >
                          <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                            ...
                            <li>
                              ...
                              >
                                {t("settingsAdmin.systemSettings")}
                              </NavLink>
                            </li>
                          </ul>
                        </div>
